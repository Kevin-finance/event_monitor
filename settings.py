...
# Credentials for kis
d['KSEC_APP_KEY'] = _config("KSEC_APP_KEY")
d['KSEC_APP_SECRET'] = _config("KSEC_APP_SECRET")
d['KSEC_APP_ID'] = _config("KSEC_APP_ID")
d['KSEC_ACCT_PW'] = _config("KSEC_ACCT_PW")
d['KSEC_ACCT_NO'] = _config("KSEC_ACCT_NO") 
d['REAL_URL'] = _config("REAL_URL")
# Credentials for etfcheck
d['EMAIL'] = _config("EMAIL")
d['EMAIL_PW'] = _config("EMAIL_PW")

# Credentials for database
d['DB_DSN'] = _config("DB_DSN")

# Credentials for KRX API
d['KRX_ID'] = _config("KRX_ID")
d['KRX_PW'] = _config("KRX_PW")
